    ...
    Public Sub UpdateValue(pRealLeft As Single, pRealRight As Single, pDesiredLeft As Single, pDesiredRight As Single, pMotorLeft As SByte, pMotorRight As SByte)
        ...
        Using g As Graphics = Me.CreateGraphics
            ...
            If X Mod 8 = 0 Then
                ...
                g.DrawLine(Drawing.Pens.Gray, X, screenYCenter - My.Settings.GMaxScrewUp * mm2screen, X + 1, screenYCenter - My.Settings.GMaxScrewUp * mm2screen)
                g.DrawLine(Drawing.Pens.Gray, X, screenYCenter + My.Settings.GMaxScrewDown * mm2screen, X + 1, screenYCenter + My.Settings.GMaxScrewDown * mm2screen)
                g.DrawLine(Drawing.Pens.DarkBlue, X, screenYCenter - CInt(My.Settings.GMinDiff * mm2screen), X + 1, screenYCenter - CInt(My.Settings.GMinDiff * mm2screen))
                g.DrawLine(Drawing.Pens.DarkBlue, X, screenYCenter + CInt(My.Settings.GMinDiff * mm2screen), X + 1, screenYCenter + CInt(My.Settings.GMinDiff * mm2screen))
            End If
            'Motors:
        ...
        End Using
        lbInfo.Text = $"{CInt(pRealLeft + My.Settings.GLeftScrewCenter) } mm  /  {CInt(pRealRight + My.Settings.GRightScrewCenter) } mm"
        X += 1
