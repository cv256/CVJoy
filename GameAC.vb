...
Public Class GameAC
    ...
    Private Function FFWind(SpeedKmh As Single, Jump As Single) As Integer
        Static lastJump As Single
        Dim res As Integer = (If(SpeedKmh > Me.MinSpeed, SpeedKmh / Me.MaxSpeed, 0) + (Jump - lastJump) / Me.Jump) * 255 ' typical 0~255, but can get to something like -2000~2000
        lastJump = Jump
